...
`;
  ...
  var translate =mat4.translate(mat4.create(), mat4.identity(mat4.create()), [s.x, s.y, s.z]);
  var rotate = mat4.rotateX(mat4.create(), mat4.identity(mat4.create()), -Math.PI / 2);
  var scale = mat4.scale(mat4.create(), mat4.identity(mat4.create()), [1, repeatTimes, 1]);
